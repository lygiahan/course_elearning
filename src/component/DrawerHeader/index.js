import { DownOutlined, ShoppingFilled } from "@ant-design/icons";
import {
  Avatar,
  Badge,
  Button,
  ...
  return (
    ...
    >
      <ul className={classes.drawer__list}>
        ...
        <li>
          <Dropdown overlay={props.menuCategory} trigger={["click"]}>
            <Link
        ...
        <li className={classes.nav__list__item}>
          <Link to="/course/All" className={classes.nav__list__item__link}>
            Khóa học
          </Link>
        </li>
        <li>
        ...
        {props.userlogin ? (
          <Popover
            ...
            trigger={["hover", "click"]}
          >
            <Avatar style={{ cursor: "pointer" }} size={44}>
              {
                <Link to="/user">
                  <Typography.Title
                    level={1}
                  ...
                  >
                    {props.crentialUser
                      ? props.crentialUser.taiKhoan.slice(0, 1)
                      : ""}
                  </Typography.Title>
                </Link>
              }
